...
class MultiLLMManager:
    ...
    def __init__(self):
        ...
        self.task_models = {
            "strategy_generation": ["versatile", "analytical", "maverick", "scout", "diverse", "reasoning", "coder", "questioner"],
            "evaluation": ["analytical", "versatile", "reasoning"],
            "learning_analysis": ["analytical", "scout", "reasoning", "questioner"],
            "risk_assessment": ["analytical", "versatile", "reasoning"],
            "pattern_recognition": ["analytical", "scout", "diverse", "reasoning", "questioner"],
            "code_generation": ["coder", "analytical", "reasoning"],
            "problem_solving": ["questioner", "reasoning", "analytical"]
        }
    ...
    def _find_fallback_model(self, preferred_model: str = None) -> str:
        ...
        # Priority order for fallbacks (Groq first, then Cloudflare)
        fallback_priority = [
            "versatile", "analytical", "maverick", "diverse", "scout",  # Groq models
            "reasoning", "coder", "questioner"  # Cloudflare models
        ]
